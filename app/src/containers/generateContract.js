...
ООО ${params['_Name1_']}, именуемое в дальнейшем Поставщик (публичный ключ в блокчейн-системе Ethereum: _getSupplier()_, в лице Константина Константиновича Константинопольского (ХХ 1111111), действующего на основании Устава организации, с одной стороны, и ООО ${params['_Name2_']} (публичный ключ в блокчейн-системе Ethereum: ${params['_getByuer_']}_), именуемый в дальнейшем Покупатель, в лице Святослава Святославовича Святославского (ХХ 1111111), действующего на основании Устава организации, с другой стороны, именуемые вместе Стороны, а по отдельности - Сторона, заключили настоящий договор (далее - Договор), исполнение которого осуществляется посредством смарт-контракта в блокчейн-системе Ethereum (далее - cмарт-контракт) (публичный адрес Смарт-контракта: ВСТАВИТЬ_АДРЕС СМАРТА_ПОСЛЕ_ДЕПЛОЯ), о нижеследующем.
